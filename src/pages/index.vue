...
import { CFlex, CHeading, CLink, CButton, CInput, CBox, chakra } from "@chakra-ui/vue-next";
...
<template>
  ...
  <AisInstantSearch :search-client="searchClient" index-name="jobs_prod">
    <CFlex :mt="space * 2" :mb="space * 4">
      <CFlex direction="column" min-w="31%" pr="12">
        <AisSearchBox>
          <template v-slot="{ currentRefinement, isSearchStalled, refine }">
            ...
            <CBox :mt="space / 2" max-h="10px" justify-content="flex-end">
              ...
              >
                <chakra.svg h="1rem" viewBox="0 0 168 24">
                  <path
      ...
      <CFlex direction="column">
        <CFlex justify="space-between">
          <CFlex>
            ...
            <CButton border-left-radius="0" px="7">Subscribe</CButton>
          </CFlex>
          <CButton>Post Job</CButton>
        </CFlex>
